		...
		<div class="pushWrapper">
			...
			<div class="sidebar">
				...
				<nav class="mainMenu">
					<ul class="menu">
						<li>
							<a class="smoothScroll" href="#timeline-part" title="What Is Luxury?"><i class="step icon-question size-24"></i><span class="text">What is Luxury?</span></a>
						</li>
						<li>
							<a class="smoothScroll" href="#stastistical-part" title="Services"><i class="icon-reciept-1 size-24"></i><span class="text">Services</span></a>
						</li>
						<li>
						...
						<li>
							<a class="smoothScroll" href="newauto.php" title="Pricing"><i class="step icon-cogs size-24"></i><span class="text">Add item</span></a>
						</li>
						<li>
							<a class="smoothScroll" href="autolist.php" title="Get a home"><i class="step icon-door-key size-24"></i><span class="text">List</span></a>
						</li>
						<li>
	...
	<div class="content">
		<div class="container-template">
		    ...
		    <div class="intro content-template">
		        <p><strong>The number-one Luxury property showcase on the web, today. </strong></p>
				<p>Luxury Homes, the number-one purveyor of Luxury Homes in the world, is proud to prsent this short online showcase to you. We hope you enjoy it.</p>
				<p>Luxury Homes is the &#8216;hidden gem&#8217; of the global luxury market, with a target audience of the most discerning high net worth individuals globally.</p>
		    </div>
		    ...
		    <ul class="timeline">					
				    ...
				    <li class="upper-line">
				    	...
				    	<span class="timeline-content paragraph-text">&#8220;My motive in launching Luxury Homes was to create a wider platform for Luxury Property Developers to better showcase their work..&#8221;
				    ...
				    <li class="upper-line">
				    	...
				    	<span class="paragraph-text timeline-content">
				    		The website combines a luxury apartments that gives both members of where to go on a practical level to find the best of the best in the world.
						</span>
				    </li>

				    <li class="year">2014</li>
				    <li class="upper-line">
				    	<span class="title">Luxury Homes started their business around the globe.
				    	</span>
			 		...
			 		<ul class="team-members">
		 				...
		 				<li>
		 					...
		 					<div class="team-member-text content-template">
		 						<p>Founder of Luxury. Doe has 27 years experience in high-end luxury, commercial and residential development.</p>
		 					</div>
		 				</li>
					</ul>
				</div>
